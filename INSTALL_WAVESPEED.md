...
**当前版本 3.1.0-cloud.5 是普通酒馆前端扩展。无需安装服务端插件，无需修改 `enableServerPlugins`。** 浏览器直接调用 WaveSpeed / Civitai；世界书、LLM、人物预设、正文手势和图片操作复用原智绘姬代码。
...
在酒馆的扩展管理中更新「智绘姬 · 云端独立版」，然后刷新页面；无需卸载、重置设置或再次导入。更新到 `3.1.0-cloud.5` 后重新打开 WaveSpeed / Civitai 页。
