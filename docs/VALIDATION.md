...
版本：3.1.0-cloud.3。检查日期：2026-09-19。

**已完成源码复用校验、23 项模拟接口测试，以及两种后端的浏览器操作检查。尚未用真实 Key 在完整酒馆实例中付费出图。**
...
当前自动测试为 23 项。`npm run check` 检查 16 个 JavaScript 文件语法、上游文件校验、7 个原模块指纹及聊天上下文模块的存储键差异、接入点和新增 HTML ID。
